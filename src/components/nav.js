...
import logo from '../assets/arDemo.png'; // Import the image
            ...
            <Navbar expand="lg" style={{ backgroundColor: '#2638c4' }}>
                <Container>
                    <Navbar.Brand href="https://pbswisconsin.org">
                        <img
                            src="https://wisconsinpublictv.s3.us-east-2.amazonaws.com/wp-content/uploads/2022/11/primetime-icons-desktop_pbs-wisconsin-1.png" // Use the imported image
                            alt="PBS Wisconsin Logo"
                            height="30"
                        />
                    </Navbar.Brand>

                    <Navbar.Toggle aria-controls="basic-navbar-nav" style={{ borderColor: 'white' }} className="custom-toggler">
                        ...
                        <Nav className="me-auto">
                            ...
                            <NavDropdown title="Watch" id="watch-dropdown">
                                ...
                                <NavDropdown.Item href="/passport/">
                                    PBS Passport
                                    <img
                                        src={logo} // Use the imported image for PBS Passport icon if needed
                                        alt="PBS Passport"
                                        height="20"
                                    />
                                </NavDropdown.Item>
